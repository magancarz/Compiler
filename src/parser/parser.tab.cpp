...
static const yytype_int8 yyrline[] =
{
      ...
      77,    80,    83,    84,    87,    90,    91,    92,    93,    94,
      95,    98,    99,   100,   101,   102,   103,   106,   107
};
#endif
...
#line 70 "src\\parser\\parser.ypp"
                                                                            { (yyval.num) = codeGenerator->assignValueToVariable(memory, *(yyvsp[-3].str), (yyvsp[-1].num)); }
